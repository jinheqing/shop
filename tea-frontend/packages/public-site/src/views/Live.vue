  ...
  <div class="pt-20 min-h-screen">
      ...
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div v-for="p in (presets.length ? presets : [
            { name: '冰岛老寨', location: '云南临沧', camera_rtmp_url: 'rtmp://localhost:1935/slow/iceland', status: 'live' },
            { name: '班章村', location: '云南勐海', camera_rtmp_url: 'rtmp://localhost:1935/slow/banzhang', status: 'live' },
            { name: '景迈山', location: '云南澜沧', camera_rtmp_url: 'rtmp://localhost:1935/slow/jingmai', status: 'live' },
    ...
    <section class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <p class="text-tea-600 mb-8">Book a 1:1 tasting with our tea advisors. They'll brew Pu'er from three mountains and walk you through the tasting notes.</p>
